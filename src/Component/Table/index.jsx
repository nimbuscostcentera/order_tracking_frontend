                    ...
                    return (
                      <td key={indexfield}>
                        ...
                        field?.fieldname == "SampleRcpVou" ? (
                          ...
                          item[field?.fieldname] == "" ||
                          item[field?.fieldname] == undefined ||
                          item[field?.fieldname] == null ? (
                            <i
                              className="bi bi-ban"
                              style={{ color: "#ff9696b5", fontSize: "22px" }}
                            ></i>
                          ) : (
                            item[field?.fieldname]
                          )
                  ...
                  <td>
                    {item?.[isCheckedField] !== 1 ? (
                      ...
                      <i
                        ...
                        style={{ color: "#34f334", fontSize: "25px" }}
                      ></i> // Check Sign
                    )}
                  </td>
                ) : null}
